...
public class TechnicalFragment extends Fragment {
    ...
    private ImageView cancel_iamage;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        if (view==null){
            ...
            isViewCreate=true;
            initData(keyword);
            System.out.println("------------我是技术oncreateview-");
            initView(view);
        }
        return view;
    }
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        ...
        if (isVisibleToUser){
            ...
            System.out.println("------------我是技术setUserVisibleHint");
         //   initData(keyword);
    ...
    private void initData(String keyword) {
        if (isViewCreate && isViewVisible) {
            NetRequestApi.getInstance().getThinkTank(1,"",keyword,"","","",pageIndex,pageSize, null,new HttpSubscriber<ThinkTank>(new SubscriberOnListener<ThinkTank>() {
                @Override
    ...
    private void initView(View view) {
        ...
        cancel_iamage = (ImageView) view.findViewById(R.id.cancel_image);
        case_search_view.setSearchViewListener(new SearchView.SearchViewListener() {
            ...
            public void onRefreshAutoComplete(String text) {
                ...
                cancel_iamage.setVisibility(View.GONE);
            ...
            public void onSearch(String text) {
               ...
               // search_or_cancle.setText("清除");
                if (TextUtils.isEmpty(text)) {
                    ...
                    layoutParams.width = w + 140;
                    case_search_view.setLayoutParams(layoutParams);
                    cancel_iamage.setVisibility(View.VISIBLE);
...
//                }
        ...
        cancel_iamage.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        mRecyclerView.setMyRecyclerViewListener(new MyRecyclerView.MyRecyclerViewListener() {
            ...
            public void onRefresh() {
                h.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        int pageIndex=1;
                        NetRequestApi.getInstance().getThinkTank(1,"",keyword,"","","",pageIndex,pageSize,caseId,new HttpSubscriber<ThinkTank>(new SubscriberOnListener<ThinkTank>() {
                            @Override
                            public void onSucceed(ThinkTank data) {
...
//                            UIHelper.showCarInfoActivity(getActivity(),carInfoList);
        ...
        btn_ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                NetRequestApi.getInstance().getThinkTank(1,caseType,keyword,brandId,faultId,selectDate,1,10,null,new HttpSubscriber<ThinkTank>(new SubscriberOnListener<ThinkTank>() {
