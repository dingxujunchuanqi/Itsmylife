package com.sinoautodiagnoseos.ui.photopicker;
...
//                    Picasso.with(mContext).load(new File(f.cover.path)).into(holder.cover);
                    Glide.with(mContext)
    ...
    class ViewHolder{
        ...
        void bindData(Folder data) {
            ...
            // 显示图片
//            Picasso.with(mContext).load(new File(data.cover.path)).into(cover);
            Glide.with(mContext)
