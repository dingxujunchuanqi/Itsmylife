package com.sinoautodiagnoseos.ui.wheelview;
...
import com.sinoautodiagnoseos.ui.wheelview.adapter.WheelViewAdapter;
...
public class WheelView extends View{
    ...
    private void drawCenterRect(Canvas canvas) {
        ...
        paint.setColor(getResources().getColor(R.color.agora_blue));
        // 设置线宽
