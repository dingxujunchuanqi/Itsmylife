...
import com.sinoautodiagnoseos.ui.personinfoui.personModel.Cityinfo;
...
public class CityPicker extends LinearLayout {
	...
	private StringBuffer city_string;
	...
	public StringBuffer getCity_string() {
		StringBuffer stringBuffer =new StringBuffer();
		 city_string = stringBuffer
				 .append(provincePicker.getSelectedText())
				 .append("-")
				 .append(cityPicker.getSelectedText())
				 .append("-")
				 .append(counyPicker.getSelectedText());
